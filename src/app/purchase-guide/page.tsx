  ...
  return (
    <>
      <Banner
        ...
        crumbs={[{ label: "Home", href: "/" }, { label: "Purchase Guide" }]}
      />

      <div className="purchase-guide-area ptb-140">
        <div className="container">
          <div className="purchase-guide-content">
            <p>
              <i>This Purchase Guide was last updated on January 1, 2025.</i>
            </p>

            <h3>1. Our website</h3>
            <p>
              Our website address is:{" "}
              <a href="http://mindohealth.com" target="_blank" rel="noreferrer">
                http://mindohealth.com
              </a>
            </p>
            ...
            <p>
              ...
              customers/ learners must first register with a personal account
            ...
            <ul>
              ...
              <li>
                ...
                collected and shared. You can manage Adobe LSOs through their
              ...
              <li>
                ...
                Advertising Alliance, or if you are located in the European
                Union, visit the Your Online Choices site. To opt out of Google
                display advertising or customize Google Display Network ads,
                visit the Google Ads Settings page. To opt out of Taboola
            ...
            <blockquote className="blockquote">
              <p>
                ...
                data from third-party platforms you connect with Mindo Health.
                We also collect some data automatically, like information about
