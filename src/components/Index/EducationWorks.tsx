...
const EducationWorks: React.FC = () => {
  return (
    <section className="education-works-area pb-140">
      <div className="container">
        ...
        >
          ...
          <motion.div
            ...
            initial={false}
          >
            <div className="education-works-image position-relative">
              <Image
          ...
          >
            ...
            >
              ...
              >
                {/* Item 1 */}
                <motion.div className="item" variants={fadeItem}>
                  <div className="icon">
                    <svg
                  ...
                  <div className="content">
                    <h3>Sign Up</h3>
                    <span>As a learner or instructor</span>
                  </div>
                </motion.div>

                {/* Item 2 */}
                <motion.div className="item wrap2" variants={fadeItem}>
                  <div className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                  ...
                  <div className="content">
                    <h3>Enroll or Create</h3>
                    <span>Join courses or build your own</span>
                  </div>
                </motion.div>

                {/* Item 3 */}
                <motion.div className="item wrap3" variants={fadeItem}>
                  <div className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                  ...
                  <div className="content">
                    <h3>Track & Certify</h3>
                    <span>Monitor growth and earn recognition</span>
                  </div>
                </motion.div>
              </motion.div>
            </motion.div>
